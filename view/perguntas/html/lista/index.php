...
<head>
    ...
    <title>Perguntas Sobre lista</title> 
</head>
<body>
     <!-- Menu -->
<header class="Home">
   ...
   <div class="lista-perguntas">
    <div class="top">
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48">
            ...
            </svg><h3>Lista HTML 5</h3>
    </div>
    <div class="inner-div">
        <ul>
            <!-- Pergunta 1 -->            
            <a href="p35.html"><li>
               <b>1.  Qual tag é usada para criar uma lista ordenada em HTML? </b>     
            </li></a>
             <!-- Pergunta 2 -->            
             <a href="p36.html"><li>
                <b> 2. Qual tag é usada para criar uma não lista ordenada em HTML? </b>
            </li></a>
            <!-- Pergunta 3 -->            
            <a href="p37.html"><li>
                <b>3. Qual atributo é utilizado para definir o valor inicial de contagem em uma lista ordenada?</b>
            </li></a>
              <!-- Pergunta 4 -->            
              <a href="p39.html"><li>
                <b>4. Como criar um item de lista em uma lista não ordenada em HTML?</b>
            </li></a>
              <!-- Pergunta 5 -->            
              <a href="p40.html"><li>
                <b>5. Qual tag HTML é usada para definir um termo em uma lista de definição? </b>
            </li></a>
