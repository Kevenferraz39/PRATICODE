...
<head>
    ...
    <title>Perguntas Sobre tabelas</title> 
</head>
<body>
     <!-- Menu -->
<header class="Home">
   ...
   <div class="lista-perguntas">
    ...
    <div class="inner-div">
        <ul>
            ...
            <!-- Pergunta 1 -->            
            <a href="p1.html"><li>
               <b>1. Qual tag é usada para criar uma tabela em HTML?</b>     
            </li></a>
             <!-- Pergunta 2 -->            
             <a href="p2.html"><li>
                <b>2. Qual atributo é usado para definir uma célula de cabeçalho em uma tabela?</b>
            </li></a>
            <!-- Pergunta 3 -->            
              <a href="p3.html"><li>
                <b>3. Qual atributo é usado para mesclar células em uma tabela HTML?</b>
            </li></a>
            <!-- Pergunta 4 -->            
              <a href="p4.html"><li>
                <b>4. Como podemos adicionar bordas a uma tabela HTML?</b>
            </li></a>
              <!-- Pergunta 5 -->            
              <a href="p5.html"><li>
                <b>5. Qual tag é usada para criar uma linha em uma tabela HTML?</b>
            </li></a>
              <!-- Pergunta 6 -->            
              <a href="p6.html"><li>
                <b>6. Como alinhar o texto à direita em uma célula de tabela HTML?</b>
            </li></a>
              <!-- Pergunta 7 -->            
              <a href="p7.html"><li>
                <b>7. Qual tag é usada para criar um cabeçalho de coluna em uma tabela HTML?</b>
            </li></a>
              <!-- Pergunta 8 -->            
              <a href="p8.html"><li>
                <b>8. Como adicionar uma cor de fundo a uma célula de tabela HTML?</b>
            </li></a>
              <!-- Pergunta 9 -->            
              <a href="p9.html"><li>
                <b>9. Qual atributo é usado para dar espaçamento interno nas células de uma tabela?</b>
            </li></a>
        </ul>
    </div>
    <center>
